function keyWordBarChartUpdate(){
    var settings = {};
    var number = 0;
    ...
    var renderChart = function(settings, newData) {
        ...
        return function(t) {
          this.textContent = i(t).toFixed(3);
        };
        });
    ...
    formatData = function(data, number){
    ...
    this.start = function(ID, rawNumber, times, height) {
        number = rawNumber;
    ...
    this.redrawNow = function(newData) {
        newData = formatData(newData, number);
